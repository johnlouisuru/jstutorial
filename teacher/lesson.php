...
$lessons_query = "SELECT * FROM lessons WHERE topic_id = ? AND is_active = 1 AND deleted_at IS NOT NULL ORDER BY lesson_order";
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold text-primary" href="#">
                ...
                <img src="../assets/img/URUScript.png" alt="JS Tutorial Logo" width="40" height="40"> VIEWING MODE!
            </a>
                        ...
                        <div class="quiz-card border rounded p-4 bg-white shadow-sm">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button class="btn btn-outline-secondary"  
                                        <?php if ($has_attempted_quiz): ?>disabled<?php endif; ?> disabled>
